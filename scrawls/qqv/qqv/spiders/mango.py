...
class MangoSpider(scrapy.spiders.Spider):
    ...
    def parse(self, response):
        ...
        for type_pid, v in self.channel_ids.items():
            ...
            print(type_pid)
            if type_pid in ['5', '2', '3', '23', '4']:
            # if type_pid in ['5']:
                continue
            else:
                print(type_pid, type_pid in ['5', '1', '2', '23', '4'], type_pid=='23')
                if type_pid == '23':
    ...
    def parse1(self, response):
        ...
        print(old_page, x_page, int(old_page) < x_page)
        if int(old_page) < x_page:
            ...
            for li in lis:
                ...
                if first_url:
                    video_id = first_url.split('/')[-1].split('.')[0]
                ...
                first_url = f'https://pcweb.api.mgtv.com/movie/list?_support=10000000&version=5.5.35&video_id={video_id}&page=0&size=30'
                if first_url:
    ...
    def parse2(self, response):
        ...
        meta = {'tx_item': tx_item}
        print(old_meta.get('type_id'),':', old_meta.get('type_pid'), ':',first_url)
